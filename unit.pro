...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.unitcoin
    BOOST_LIB_SUFFIX=-mt
...
contains(UNIT_NEED_QT_PLUGINS, 1) {
    DEFINES += UNIT_NEED_QT_PLUGINS
...
# also add new translations to unit.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/unitclient*.ts)
...
macx:ICON = src/qt/res/icons/unit.icns
macx:TARGET = "UnitClient"
