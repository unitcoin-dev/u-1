...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "UnitCoin started 03.12.2016";
        CTransaction txNew;
        ...
        vSeeds.push_back(CDNSSeedData("unitcoin.us",  "seed.unitcoin.us"));
    }
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("031abdef92b2d59943e57aaa8b1adbb110ff215fc4ebdc6fb5c9a797e2b1dea527");
        ...
        nFirstPosv2Block = 31000;
        nFirstPosv3Block = 51000;
        ...
        genesis.nNonce   = 1131922;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000ffffc58a9b96cf7e4d4f951238950d029a1c139deef9e3a97e4db8b6fea"));
        assert(genesis.hashMerkleRoot == uint256("0x7ae44234b388304650673ade6764dc9ac7b149fc2db45aa51f227845b9bdb98b"));
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("03abd8dce43eb98374bcfff2352cd559e6774fd6a87eef73b2fbdb39b2b0bc0082");
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 11779;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000ddcfeb4a843952ac8d341fac5a7013c12d77333c2245caead622a8ca3340"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x1ab09cdb1bd78bf85911dd5f80c34928d462aa6b90aebd725efdf4bd7711d6c3"));
