...
/**
  Unit GUI main class. This class represents the main window of the Unit UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class UnitGUI : public QMainWindow
{
    Q_OBJECT
public:
