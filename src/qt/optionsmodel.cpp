...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::UNIT).toInt();
    ...
    fAutoRedeemUnit = settings.value("fAutoRedeemUnit", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemUnit: return "AutoRedeemUnit";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::UNIT).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemUnit: {
            fAutoRedeemUnit = value.toBool();
            settings.setValue("fAutoRedeemUnit", fAutoRedeemUnit);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemUnit() { return fAutoRedeemUnit; }
